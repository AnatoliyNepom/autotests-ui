...
class TestAuthorization:
    ...
    def test_successful_authorization(
        ...
        registration_page.registration_form.fill(email = 'katana@gmail.com', username = 'katana', password = 'kpass123')
        registration_page.click_registration_button()

        dashboard_page.toolbar_view.check_visible()
        dashboard_page.navbar.check_visible('katana')
        dashboard_page.sidebar.check_visible()
        dashboard_page.sidebar.click_logout()

        login_page.login_form.fill(email = 'katana@gmail.com', password = 'kpass123')
